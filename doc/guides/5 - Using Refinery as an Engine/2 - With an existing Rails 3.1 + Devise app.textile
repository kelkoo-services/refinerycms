...
<<<<<<< HEAD:doc/guides/5 - Using Refinery as an Engine/2 - With an existing Rails 3.1 + Devise app.textile
...
>>>>>>> 2-1-main:doc/guides/5 - Using Refinery as an Engine/2 - With an existing Rails 3.1 + Devise app.textile
